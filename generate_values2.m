...
for i = 1:length(missing_conc)
    ...
    switch missing_conc(i)
        ...
        case 4
            % MKK3_phosphatase - range 10E-03 to 10E02 
            % between( 1 and 10E05)/10E03
            new_conc(i,1) = 4;
            new_conc(i,2) = randomizer(10E-03, 10E02, randomization_type)/1E6;
            
        case 7
            % MK2_phosphatase  - range 10E-03 to 10E02
            new_conc(i,1) = 7;
            new_conc(i,2) = randomizer(10E-03, 10E02, randomization_type)/1E6;
        ...
        case 13
            % Hsp27_phosphatase  - range 10E-03 to 10E02
            new_conc(i,1) = 13;
            new_conc(i,2) = randomizer(10E-03, 10E02, randomization_type)/1E6;
        ...
        case 24
            % p38_phosphatase  - range 10E-03 to 10E02
            new_conc(i,1) = 24;
            new_conc(i,2) = randomizer(10E-03, 10E02, randomization_type)/1E6;
            
        case 25
            % MKK6_phosphatase - range 10E-03 to 10E02
            new_conc(i,1) = 25;
            new_conc(i,2) = randomizer(10E-03, 10E02, randomization_type)/1E6;
        ...
        case 37
            % p38_phosphatase_nucleus  - range 10E-03 to 10E02
            new_conc(i,1) = 37;
            new_conc(i,2) = randomizer(10E-03, 10E02, randomization_type)/1E6;
...
for i = 1:length(missing_params)
    ...
    switch missing_params(i)
        ...
        case 6
            % main.P.kr_p38PMK2P - range 10E-04 to 10E01
            new_param(i,1) = 6;
            new_param(i,2) = randomizer(10E-04, 10, randomization_type);
                       
        case 7
            % main.P.kr_LPS_TLR4  - range 10E-04 to 10E01 
            new_param(i,1) = 7;
            new_param(i,2) = randomizer(10E-04, 10, randomization_type);
            
        case 8
            % main.P.kr_p38_MKK6 - range 10E-04 to 10E01 
            new_param(i,1) = 8;
            new_param(i,2) = randomizer(10E-04, 10, randomization_type);
            
        case 9
            % main.P.kr_p38P_Ppas  - range 10E-04 to 10E01  
            new_param(i,1) = 9;
            new_param(i,2) = randomizer(10E-04, 10, randomization_type);
        ...
        case 32      
            ...
            new_param(i,1) = 32;
            new_param(i,2) = randomizer(10E-02, 10E02, randomization_type);
        case 34      
            % main.P.kf_MK2_p38 - RANGE 10^4 to 10^7
            new_param(i,1) = 34;
            new_param(i,2) = randomizer(10E04, 10E07, randomization_type);
        ...
        case 122     
            ...
            new_param(i,1) = 122;
            new_param(i,2) = randomizer(10E-04, 100, randomization_type);
        ...
        case 146      
            ...
            % of 0.0001 to 1E-15
             new_param(i,1) = 146;
             new_param(i,2) = randomizer(1E-15, 0.0001, randomization_type);
